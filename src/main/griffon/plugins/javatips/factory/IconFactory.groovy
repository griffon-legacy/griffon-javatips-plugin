...
class IconFactory extends AbstractFactory {
    ...
    Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) {
        ...
        if (attributes.containsKey("description")) {
            return iconClass.newInstance(value, attributes.remove("description"))
        } else {
            return iconClass.newInstance(value)
        }
    }
    
    protected findIconValue(FactoryBuilderSupport builder, Object name, Object value, Map attributes) {
        if (value == null) {
